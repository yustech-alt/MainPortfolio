...
const projects = [
  ...
  {
    id: 4,
    title: "Nikkis-Ecommerces",
    desc: "An e-commerce platform for a fictional fashion brand with a modern design and seamless shopping experience.",
  ...
  {
    id: 5,
    title: "SanturayHealth",
    desc: "SanctuaryHealth is a web tool that helps low-income Nigerians find out the cost of treatment before visiting a clinic — reducing cost-related health avoidance and dangerous self-medication.",
